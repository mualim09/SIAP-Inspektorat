                                ...
                                <hr>
                                    ...
                                    <table class="laporan info">
                                        ...
                                        <td class="laporan info-nama" style="padding-left: 75px !important;">
                                            <p>:  <input class="form-control" type="number" name="kode_lhp" style="width: 21.7%;display: inline;" placeholder="Kode LHP">{!!$nomor_lhp!!} </p>
                                            ...
                                            <table class="tabel simpulan">
                                                <?php
                                                    for($i=0;$i<count($data_pemeriksaan);$i++) //judultemuan yang ditampilkan hanya data dari anggota tim
                                                    {
                                                        ...
                                                        echo "<td>".'1'.". ".$data_pemeriksaan[$i]->judultemuan."<br>".json_decode($data_pemeriksaan[$i]->kriteria)."</td>"; // isi
                                                        echo "</tr>";
                                                    }
                                                ?>
                                            </table>
                                            ...
                                            <div class="point isi-hasil-pemeriksaan" style="margin: 40px;margin-top: 0px;">
                                                ...
                                                <?php
                                                    ...
                                                    foreach ($data_pemeriksaan as $key => $value) {
                                                        ...
                                                        echo "</tr>";
                                                        echo "<tr>";
                                                        echo "<td>".'Sebab<br><div class="point isi-hasil-pemeriksaan" style="width: 97%;margin-left: 20px;margin-top: 0px;"><textarea type="textarea" class="form-control" name="point_kka_lhp[lhp-sebab-'.$key.']"></textarea></div>'."</td>"; // isi
                                                        echo "</tr>";
                                                        echo "<tr>";
                                                        echo "<td>".'Akibatnya<br><div class="point isi-hasil-pemeriksaan" style="width: 97%;margin-left: 20px;margin-top: 0px;"><textarea type="textarea" class="form-control" name="point_kka_lhp[lhp-akibat-'.$key.']"></textarea></div>'."</td>"; // isi
                                                        echo "</tr>";
                                                        echo "<tr>";
                                                        echo "<td>".'Komentar yang diperiksa<br><div class="point isi-hasil-pemeriksaan" style="width: 97%;margin-left: 20px;margin-top: 0px;"><textarea type="textarea" class="form-control" name="point_kka_lhp[lhp-komentar-'.$key.']"></textarea></div>'."</td>"; // isi
                                                        echo "</tr>";
                                                        echo "<tr>";
                                                        echo "<td>".'Rekomendasi<br><div class="point isi-hasil-pemeriksaan" style="width: 97%;margin-left: 20px;margin-top: 0px;"><textarea type="textarea" class="form-control" name="point_kka_lhp[lhp-rekomendasi-'.$key.']"></textarea></div>'."</td>"; // isi
                                                        echo "</tr>";
                                                    }
                                                ?>
                                            </table>
...
<script type="text/javascript">
      ...
      $(document).ready(function(){
          ...
          $('.finish').click(function(){
              $.confirm({
                  title: "{{ __('Perhatian!') }}",
                  content: "{{ __('<b>Apakah anda sudah yakin dengan data yang anda inputkan ?</b>') }}",
                  buttons: {
                      Simpan: {
